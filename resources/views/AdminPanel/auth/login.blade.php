                            ...
                            <div class="card-body">
                                <a href="{{url('/')}}" class="brand-logo">
                                    @if(getSettingValue('logo') != '')
                                        <img src="{{getSettingImageLink('logo')}}" width="40%">
                                    @endif
                                </a>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        {{Form::text('email','',['class'=>'form-control', 'id'=>'login-email', 'placeholder'=>'اسم المستخدم / هاتف محمول', 'aria-describedby'=>'login-email', 'tabindex'=>'1', ''])}}
                                        @error('email')
