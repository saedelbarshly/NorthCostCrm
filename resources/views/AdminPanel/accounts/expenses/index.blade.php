                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-3">
                            ...
                            {{Form::select('month[]',monthArray(session()->get('Lang')),isset($_GET['month']) ? $_GET['month'] : date('m'),['id'=>'month', 'class'=>'selectpicker','multiple'])}}
                        </div> 
                        <div class="col-12 col-md-3">
                        ...
                        <div class="col-12 col-md-3">
                            <label class="form-label" for="Type">{{trans('common.type')}}</label>
                            {{Form::select('Type',['all'=>'الجميع'] + expensesTypes(session()->get('Lang')),$type,['id'=>'Type', 'class'=>'form-select','required'])}}
                        </div>
