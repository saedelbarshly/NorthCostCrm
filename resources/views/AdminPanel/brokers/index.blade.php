    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                        ...
                        <tbody>
                          ...
                          @endif
                                ...
                                <td class="text-center">
                                    ...
                                    <?php $delete = route('admin.broker.delete',$value->id); ?>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.broker.update',$value->id), 'class'=>'row gy-1 pt-75'])}}
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        {{Form::text('email',$value->email,['id'=>'email', 'class'=>'form-control'])}}
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label class="form-label" for="identity">{{trans('common.identity')}}</label>
                                        {{Form::number('identity',$value->identity,['id'=>'identity', 'class'=>'form-control'])}}
                                    </div>
                                    <div class="col-12 col-md-4">
                                        <label class="form-label" for="email">{{trans('common.email')}}</label>
                                        {{Form::text('email',$value->email,['id'=>'email', 'class'=>'form-control'])}}
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            {{Form::select('governorate_id', [''=>'اختر']+$governorates,$value->governorate_id, ['id'=>'governorates', 'class'=>'form-select','onchange'=>'showElemet(this,this.value)'])}}
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            {{Form::select('city_id',[]+$this_city,$value->city_id,['id'=>'cities','class'=>'form-control'])}}
                                        </div>
                                    </div>
                ...
                {{ $brokers->links('vendor.pagination.default') }}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.broker.store'), 'class'=>'row gy-1 pt-75'])}}
                        <div class="col-12 col-md-4">
                            <label class="form-label" for="name">{{trans('common.name')}}</label>
                        ...
                        <div class="col-12 col-md-4">
                            <label class="form-label" for="identity">{{trans('common.identity')}}</label>
                            {{Form::number('identity','',['id'=>'identity', 'class'=>'form-control'])}}
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label font-medium-2" for="commission">{{ trans('common.commission') }}</label>
                            {{ Form::number('commission', '', ['id' => 'commission', 'class' => 'form-control ','step' => '0.0001']) }}
                        </div>
                        {{-- @dd($governorates); --}}
                        <div class="row">
                            <div class="col-12 col-md-6">
...
@section('scripts')
    <script>
        function showElemet(elem,val)
        {
            ...
            console.log(row);
            var url = '<?php echo url("AdminPanel/broker/getZone"); ?>/'+val;
