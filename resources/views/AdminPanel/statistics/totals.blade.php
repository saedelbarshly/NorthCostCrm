...
<div class="col-md-12 col-12 mb-4">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <div>
                <h5 class="card-title mb-0">حالات العملاء</h5>
            </div>
            <div class="dropdown d-none d-sm-flex">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.index', ['today' => now()->startOfDay()->toDateString() ,'key' =>'client']) }}">
                            Today
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.index', ['yesterday' => now()->subDays(1)->startOfDay()->toDateString() ,'key' =>'client']) }}">
                            Yesterday
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.index', ['yesterday' => now()->subDays(7)->startOfDay()->toDateString() ,'key' =>'client']) }}">
                            Week
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.index', ['month' => now()->subDays(30)->startOfDay()->toDateString() ,'key' =>'client']) }}">
                            Last Month
                        </a>
                    </li>
                </ul>
